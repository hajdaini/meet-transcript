...
Meet Transcript is a local Windows desktop app built with Python and PySide6. It records microphone audio and Windows system audio, imports existing audio files, then generates local meeting transcripts with faster-whisper.
